...
IMPORTANT: NSE2 relies on Docker's `com.docker.network.container_iface_prefix` option to assign predictable names to container network interfaces. Podman does not provide this Docker-specific behavior and is therefore not supported.
