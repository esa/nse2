...
# Command: random-contacts.py scenarios/eo/actual_contacts.ccp scenarios/eo/testing_contacts.ccp --length 120 --min-contact 30 --max-contact 30 --seed 0
s loop 1
...
a contact +65 +95 sat gs2 1gbit 0 57 0
